package com.midorlo.k9.web.advice;
...
public class SecurityExceptionControllerAdvice implements ProblemHandling,
    ...
    public ResponseEntity<Problem> process(@Nullable ResponseEntity<Problem> entity,
        ...
        ProblemBuilder builder = Problem
                .builder()
                .withType(Problem.DEFAULT_TYPE.equals(problem.getType()) ? SecurityConstants.DEFAULT_TYPE :
                          problem.getType())
        ...
        if (problem instanceof ConstraintViolationProblem) {
            builder
                    ...
                    .with(MESSAGE_KEY, SecurityConstants.ERR_VALIDATION);
        } else {
    ...
    public ResponseEntity<Problem> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        Problem problem = Problem
                .builder()
                .withType(SecurityConstants.CONSTRAINT_VIOLATION_TYPE)
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(EmailAlreadyUsedException ex,
        ...
        return create(problem,
                      request,
                      RestUtilities.createFailureAlert(applicationName, true, problem.getEntityName(),
                                                       problem.getErrorKey(),
                                                       problem.getMessage()));
    }
    ...
    public ResponseEntity<Problem> handleBadRequestAlertException(BadRequestAlertException ex,
        ...
        return create(ex,
                      request,
                      RestUtilities.createFailureAlert(applicationName,
                                                       true,
                                                       ex.getEntityName(),
                                                       ex.getErrorKey(),
                                                       ex.getMessage()));
    ...
    public ResponseEntity<Problem> handleConcurrencyFailure(ConcurrencyFailureException ex,
        ...
        return create(ex,
                      Problem.builder()
                             ...
                             .with(MESSAGE_KEY, SecurityConstants.ERR_CONCURRENCY_FAILURE)
                             .build(),
                      request);
    }
